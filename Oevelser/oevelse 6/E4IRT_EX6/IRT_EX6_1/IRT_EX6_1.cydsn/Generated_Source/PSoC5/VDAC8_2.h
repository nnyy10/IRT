...
***************************************/
 ...
 /* Default DAC range */
#define VDAC8_2_DEFAULT_RANGE    4u
 /* Default DAC speed */
#define VDAC8_2_DEFAULT_SPEED    2u
 /* Default Control */
#define VDAC8_2_DEFAULT_CNTL      0x00u
/* Default Strobe mode */
#define VDAC8_2_DEFAULT_STRB     0u
 /* Initial DAC value */
#define VDAC8_2_DEFAULT_DATA     125u
 /* Default Data Source */
#define VDAC8_2_DEFAULT_DATA_SRC 0u


/***************************************
*              Registers        
***************************************/
#define VDAC8_2_CR0_REG            (* (reg8 *) VDAC8_2_viDAC8__CR0 )
#define VDAC8_2_CR0_PTR            (  (reg8 *) VDAC8_2_viDAC8__CR0 )
#define VDAC8_2_CR1_REG            (* (reg8 *) VDAC8_2_viDAC8__CR1 )
#define VDAC8_2_CR1_PTR            (  (reg8 *) VDAC8_2_viDAC8__CR1 )
#define VDAC8_2_Data_REG           (* (reg8 *) VDAC8_2_viDAC8__D )
#define VDAC8_2_Data_PTR           (  (reg8 *) VDAC8_2_viDAC8__D )
#define VDAC8_2_Strobe_REG         (* (reg8 *) VDAC8_2_viDAC8__STROBE )
#define VDAC8_2_Strobe_PTR         (  (reg8 *) VDAC8_2_viDAC8__STROBE )
#define VDAC8_2_SW0_REG            (* (reg8 *) VDAC8_2_viDAC8__SW0 )
#define VDAC8_2_SW0_PTR            (  (reg8 *) VDAC8_2_viDAC8__SW0 )
#define VDAC8_2_SW2_REG            (* (reg8 *) VDAC8_2_viDAC8__SW2 )
#define VDAC8_2_SW2_PTR            (  (reg8 *) VDAC8_2_viDAC8__SW2 )
#define VDAC8_2_SW3_REG            (* (reg8 *) VDAC8_2_viDAC8__SW3 )
#define VDAC8_2_SW3_PTR            (  (reg8 *) VDAC8_2_viDAC8__SW3 )
#define VDAC8_2_SW4_REG            (* (reg8 *) VDAC8_2_viDAC8__SW4 )
#define VDAC8_2_SW4_PTR            (  (reg8 *) VDAC8_2_viDAC8__SW4 )
#define VDAC8_2_TR_REG             (* (reg8 *) VDAC8_2_viDAC8__TR )
#define VDAC8_2_TR_PTR             (  (reg8 *) VDAC8_2_viDAC8__TR )
/* Power manager */
#define VDAC8_2_PWRMGR_REG         (* (reg8 *) VDAC8_2_viDAC8__PM_ACT_CFG )
#define VDAC8_2_PWRMGR_PTR         (  (reg8 *) VDAC8_2_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC8_2_STBY_PWRMGR_REG    (* (reg8 *) VDAC8_2_viDAC8__PM_STBY_CFG )
#define VDAC8_2_STBY_PWRMGR_PTR    (  (reg8 *) VDAC8_2_viDAC8__PM_STBY_CFG )
