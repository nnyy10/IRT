...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)(0x48000048u + CYAPP_ECC_OFFSET))

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)(0x48000088u + CYAPP_ECC_OFFSET))

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x48000090u + CYAPP_ECC_OFFSET))

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x48000098u + CYAPP_ECC_OFFSET))

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)(0x480000A4u + CYAPP_ECC_OFFSET))
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x240Eu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT1_AMUX, 0x04u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AMUX, 0x40u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BG_CR0, 0x0Cu);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0105u);
