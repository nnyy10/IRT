// ======================================================================
// IRT_EX5_2.v generated from TopDesign.cysch
// 04/08/2015 at 21:30
...
// OpAmp_v1_90(Mode=1, Power=3, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Opamp_1, )
...
// OpAmp_v1_90(Mode=1, Power=3, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Opamp_3, CY_INSTANCE_SHORT_NAME=Opamp_3, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Opamp_3, )
...
// Filter_v2_20(ChannelEnableA=true, ChannelEnableB=false, ChannelSettingsA=<enabled=true>\r\n<userEntryEnabled=true>\r\n<sampleRate=2.5>\r\n<filterGain_dB=0>\r\n<filterGain_Linear=1>\r\n<gainScale=LINEAR>\r\n<width=WIDTH_16>\r\n<signal=INTERRUPT>\r\n<stage_count=1>\r\n<bus_clock=0.05>\r\n<stage0=\r\n    <design_type=BIQUAD>\r\n    <pass_type=LOW_PASS>\r\n    <shape=BUTTERWORTH>\r\n    <order=16>\r\n    <ripple=0.1>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=1/0/0/0/0/>\r\n    <userOrder=2>\r\n>\r\n<stage1=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage2=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage3=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage4=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=1/-0.8718/0/-0.0379/0/>\r\n    <userTapCount=5>\r\n>\r\n<stage5=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage6=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage7=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n, ChannelSettingsB="", ChannelTypeA=11, ChannelTypeB=0, CoefficientEntryEnableA=true, CoefficientEntryEnableB=false, DisplaySettingsA=50310, DisplaySettingsB=50307, DmaEnableA=false, DmaEnableB=false, IrqEnableA=true, IrqEnableB=false, MinBusClockVal=0.05, CY_COMPONENT_NAME=Filter_v2_20, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Filter, CY_INSTANCE_SHORT_NAME=Filter, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Filter, )
...
module top ;
    ...
    ADC_DelSig_v3_10_0 ADC_DelSig_1 (
        .vplus(Net_2),
        .vminus(Net_3),
        .soc(1'b1),
        .eoc(Net_48),
    ...
    defparam VDAC8_1.Initial_Value = 1;
    defparam VDAC8_1.Strobe_Mode = 0;

    VDAC8_v1_90_4 VDAC8_2 (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_3));
    defparam VDAC8_2.Data_Source = 0;
    defparam VDAC8_2.Initial_Value = 125;
	...
	cy_psoc3_pins_v1_10
		#(.id("4fa81d14-b5fc-492e-a901-e05aa35f2fe8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Diode_1_net;
	wire [0:0] tmpFB_0__Diode_1_net;
	wire [0:0] tmpIO_0__Diode_1_net;
	wire [0:0] tmpINTERRUPT_0__Diode_1_net;
	electrical [0:0] tmpSIOVREF__Diode_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0e0c9380-6965-4440-8709-ce08a91e474c"),
		  ...
		  .width(1))
		Diode_1
		 (.oe(tmpOE__Diode_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Diode_1_net[0:0]}),
		  .io({tmpIO_0__Diode_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Diode_1_net),
		  .interrupt({tmpINTERRUPT_0__Diode_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Diode_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
